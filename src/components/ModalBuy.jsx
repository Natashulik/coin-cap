...
const ModalBuy = () => {
  ...
  const { walletAmount, walletCryptos } = useSelector(state => state.wallet);
  ...
  return <div className="modal_buy">
    ...
    >
      ...
      <Form.Item name="amount"
        style={{ marginBottom: "10px" }} >
        <Typography.Text strong style={{ fontFamily: "Open Sans", fontSize: "16px" }} > Amount is
          <span style={{ color: '#00B96B' }}> {formatedPrice(cryptoQuantity * priceUsd)} </span>  USD
        </Typography.Text>
      </Form.Item>
      ...
      >
        <Button type="primary" htmlType="submit"
          style={{
            width: "100px", fontFamily: "Open Sans", fontSize: "16px", paddingTop: "0",
